...
export default function AveragePrices({ community }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-[22px] w-full max-w-[1080px] mx-auto mt-[75px] px-4">
      <p className="CormorantGaramond text-[28px] font-[900] leading-[1.08] text-[#050505] [text-shadow:0_0_0.45px_#050505] lg:text-[34px]">Average property prices per sqft – {community}</p>
