...
export default function ContactUsForm() {
  ...
  return (
    <div className="flex flex-col items-start gap-[22px] w-full mt-[112px]">
      <div className="flex items-center gap-[39px] w-full p-[11px] rounded-[9px] border border-[#C6A45A] overflow-hidden relative z-10">
        <img src={icon.Ellipse8} alt="" className="absolute bottom-0 right-0 z-[-1]" />
        <div
          className="flex flex-col items-start justify-between p-[44px] w-full max-w-[490px] aspect-[490/727] rounded-[11px] text-white"
          style={{ background: "linear-gradient(170deg, #C6A45A 7.6%, #FFF 168.8%)" }}
        >
          <div className="flex flex-col items-start gap-[98px]">
        ...
        <div className="flex flex-col items-center gap-[64px] w-full">
          <div className="flex flex-col items-start gap-[67px] w-full">
            <div className="flex flex-col items-start gap-[54px] w-full">
