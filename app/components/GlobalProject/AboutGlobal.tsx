  ...
  return (
    <div className="flex flex-col items-start gap-[33px] w-full">
      ...
      <p className="text-[27px] ">
        ...
        Commission on Foreign Policy, taught at thAcademy of Public Administration and was the owner
        of his own real estate agency in Chisinau.t Dimitry holds a leading position and sets the
        vector for the development of not only his team, which he calls «My Champions but also the
        eeam, which he calls «My Champions but also the eeam, which .
      </p>
    </div>
  );
}
