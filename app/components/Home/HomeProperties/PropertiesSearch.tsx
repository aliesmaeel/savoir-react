...
export default function PropertiesSearch() {
  const icon = useIcons();
  return (
    <div className="flex items-center gap-[9px] lg:gap-[18px] w-full rounded-full px-[27px] lg:px-[50px] py-[11px] lg:py-[20px] border border-[#C6A45A] bg-white h-[42px] lg:h-[79px]">
