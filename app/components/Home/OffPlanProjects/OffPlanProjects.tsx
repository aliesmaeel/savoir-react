  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto w-full flex flex-col lg:flex-row lg:items-end justify-between gap-[20px] px-[24px] lg:px-[52px] pt-[36px] lg:pt-[64px] pb-[24px] lg:pb-[40px] border-b-[0.5px] border-[#35363540]">
        ...
        <Link
          to="/off-plan"
          className="Jakarta text-[10px] font-semibold tracking-[0.2em] uppercase text-[#0A0A0A] hover:text-[#C6A45A] inline-flex items-center gap-[8px] group transition-colors"
        >
          All Projects
      ...
      <div className="max-w-[1280px] mx-auto w-full px-[24px] lg:px-[52px] py-[40px] lg:py-[60px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 border-t-[0.5px] border-l-[0.5px] border-[#35363540]">
          {projects.map((p, idx) => {
            ...
            return (
              <Link
                key={p.id ?? idx}
                to={`/off-plan/${slug}`}
                className="relative border-r-[0.5px] border-b-[0.5px] border-[#35363540] cursor-pointer overflow-hidden bg-white transition-shadow duration-300 hover:shadow-[0_20px_50px_rgba(0,0,0,0.11)] hover:z-[2] group block"
              >
                <div className="relative overflow-hidden aspect-[3/2] bg-white">
                  <img
                    loading="lazy"
                    src={p.image}
                    alt={p.title}
                  ...
                  <span className="absolute top-0 left-0 Jakarta text-[8px] font-semibold tracking-[0.14em] uppercase bg-[#C6A45A] text-white px-[12px] py-[5px]">
                    Off Plan
                  </span>
                </div>
                ...
                <div className="px-[18px] pt-[18px] pb-[20px]">
                  <p
                    className="CormorantGaramond text-[18px] leading-[1.22] mb-[5px] group-hover:text-[#8C6E32] transition-colors line-clamp-2"
                    style={{
                      color: "#000000",
                      fontWeight: 600,
                      opacity: 1,
                  ...
                  {(p.developer || p.location) && (
                    <p
                      className="Jakarta text-[10px] mb-[14px] line-clamp-1"
                      style={{
                        color: "#111111",
                        fontWeight: 500,
                        opacity: 1,
                  ...
                  {p.completion_date && (
                    <>
                      <div className="flex justify-between items-center mb-[5px]">
                        <span
                          className="Jakarta text-[9px] tracking-[0.1em] uppercase"
                          style={{
                            color: "#111111",
                            fontWeight: 500,
                            opacity: 1,
                        ...
                        <span className="Jakarta text-[9px] tracking-[0.1em] uppercase text-[#8C6E32] font-semibold">
                          {p.completion_date}
                        </span>
                      </div>

                      <div className="h-[1px] bg-[#35363540] mb-[14px] relative overflow-hidden">
                        <div
                  ...
                  <div className="flex justify-between items-end border-t-[0.5px] border-[#35363540] pt-[12px]">
                    {p.starting_price ? (
                      <span
                        className="CormorantGaramond text-[17px]"
                        style={{
                          color: "#000000",
                          fontWeight: 600,
                          opacity: 1,
