...
export default function OffPlanStartingPrice() {
  ...
  return (
    <div className="flex flex-col gap-[40px] px-[30px] py-[45px] border border-[#C6A45A] rounded-[15px] w-full lg:w-[439px] shrink-0 bg-white relative overflow-hidden z-10">
