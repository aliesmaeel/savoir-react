...
export default function Footer() {
  return (
    <div className="flex flex-col items-start w-full px-[30px] ">
      <div className="flex items-start gap-[30px] w-full pb-[60px] max-w-[1330px] mx-auto">
        <FooterAbout />
        <FooterLatestListings />
        <FooterUsefulLinks />
        <FooterContactUs />
      </div>
      <hr className="w-full border-[#353635] max-w-[1330px] mx-auto" />
      <div className="flex items-center justify-between w-full py-[27px] max-w-[1330px] mx-auto">
