  ...
  return (
    <div>
      ...
      <PageLayout>
        ...
        <AboutCoreValues />
        <div
          className="flex flex-col items-center gap-[17px] w-full pt-[27px] pb-[20px] p-[60px] border-l-[8px] border-[#C6A45A] mt-[108px]"
          style={{
            background:
              "linear-gradient(90deg,rgba(255, 255, 255, 0) 0%, rgba(240, 232, 214, 1) 50%, rgba(255, 255, 255, 0) 100%)",
          }}
        >
          <p className="text-[31px] text-center leading-[176.19%]">
